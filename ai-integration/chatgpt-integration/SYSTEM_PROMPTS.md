# HELIOS System Prompts for ChatGPT

Pre-built system prompts optimized for ChatGPT integration with HELIOS Platform.

## 1. HELIOS Optimizer

**Purpose**: Get optimization suggestions for AppLocker configurations.
...
5. Highlight risks and tradeoffs

## 2. Security Architect

**Purpose**: Evaluate security implications of AppLocker configurations.
...
**Purpose**: Assess performance impact of AppLocker configurations.
...
**Purpose**: Recommend optimal AppLocker phases and components.
...
**Purpose**: Identify potential rule conflicts and precedence issues.
...
- Ambiguous rule scenarios

## 6. Code Reviewer

**Purpose**: Review PowerShell scripts and HELIOS code for best practices.
