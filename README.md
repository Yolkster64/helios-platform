...
| Absorption program | `config/absorption/pr-watchlist.json` → `pwsh scripts/absorption/absorb-pr.ps1 -PrNumber <N>` → `helios-ai absorb-status` | [ABSORPTION_PIPELINE.md](docs/architecture/ABSORPTION_PIPELINE.md), [ABSORPTION_LEDGER.md](docs/architecture/ABSORPTION_LEDGER.md) |
